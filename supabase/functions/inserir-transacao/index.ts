...
Deno.serve(async (req: Request) => {
  ...
  try {
    console.log(
      JSON.stringify({
        severity: 'INFO',
        message: 'Iniciando inserir-transacao',
    ...
    console.log(
      JSON.stringify({
        severity: 'INFO',
        message: `Dados recebidos: Operação: ${tipo_operacao}, Valor: ${valor}`,
      }),
    )
    ...
    console.log(
      JSON.stringify({ severity: 'INFO', message: 'Iniciando RPC inserir_transacao_atomicamente' }),
    )
    ...
    console.log(
      JSON.stringify({ severity: 'INFO', message: 'Transação concluída com sucesso', rpcData }),
    )
